                                    ...
                                    <div className="col-12 mt-4 pt-2">
                                        <div className="card border-0 rounded shadow">
                                            <div className="d-flex justify-content-between px-4 pt-4">
                                                <h6 className="align-items-center mb-0">Water <span className="badge badge-pill badge-soft-primary ms-1">93%</span></h6>
                                    ...
                                    <div className="col-12 mt-4 pt-2">
                                        <div className="card border-0 rounded shadow p-4">
                                            <div className="d-flex justify-content-between mb-3">
                                                <h6 className="align-items-center mb-0">Hemoglobin <span className="badge badge-pill badge-soft-success ms-1">19.5 g/dL</span></h6>
                            ...
                            <div className="col-xl-3 col-lg-6 col-12">
                                <div className="row">
                                    <div className="col-12 mt-4 pt-2">
                                        <div className="card border-0 rounded shadow p-4">
                                            <div className="d-flex justify-content-between mb-3">
                                                <h6 className="align-items-center mb-0">Heartbeat <span className="badge badge-pill badge-soft-danger ms-1">80 bpm</span></h6>
                                    ...
                                    <div className="col-12 mt-4 pt-2">
                                        <div className="card border-0 rounded shadow">
                                            <div className="d-flex justify-content-between px-4 pt-4">
                                                <h6 className="align-items-center mb-0">Sugar levels <span className="badge badge-pill badge-soft-warning ms-1">90 mg/dL</span></h6>
