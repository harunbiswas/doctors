                                    ...
                                    <div className="p-4">
                                        ...
                                        <Slider {...settings}>
                                            ...
                                            <div key={i} className="tiny-slide">
                                                <p className="text-muted fst-italic">" It seems that only melodies in order to have a 'ready-made' text to sing with the melody of the originalthe 'Lorem Ipsum', which is said to have originated century. "</p>
