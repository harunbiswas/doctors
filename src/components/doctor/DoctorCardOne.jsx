...
import img from "../../assets/images/doctors/05.jpg";

 export default function DoctorCardOne() {
    ...
    return(
        ...
        <div className="card team border-0 rounded shadow overflow-hidden">
                                                ...
                                                <div className="card-body">
                                                    <a href="#" className="title text-dark h5 d-block mb-0">Jessica McFarlane</a>
                                                    <small className="text-muted speciality">M.B.B.S, Dentist</small>
