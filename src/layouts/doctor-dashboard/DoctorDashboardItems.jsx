                            ...
                            <div key={i} className="col-xl-3 col-md-6 mt-4">
                                <div className="card features feature-primary text-center border-0 p-4 rounded shadow">
                                    <div className="icon text-center rounded-lg mx-auto">
                                        <i className="uil uil-message align-middle h3 mb-0"><AiOutlineSend /></i>
                                    </div>
                                    <div className="card-body p-0 mt-3">
                                        ...
                                        <a href="javascript:void(0)" className="link">Read more <i className="ri-arrow-right-line align-middle"><MdArrowForward /></i></a>
                                    </div>
                                </div>
                            </div>
                            ))}
