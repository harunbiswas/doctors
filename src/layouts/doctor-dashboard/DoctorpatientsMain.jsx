          ...
          <div key={i} class="col-xl-3 col-lg-6 col-12 mt-4 pt-2">
            <div class="card border-0 shadow rounded p-4">
              <div class="d-flex justify-content-between">
                <img
                  src={img}
                  class="avatar avatar-md-md rounded-pill shadow"
                  alt=""
                />

                <div class="dropdown dropdown-primary">
                  <button
                    onClick={(e) => toggleHandler(patient.id)}
                    type="button"
                    class={`btn btn-icon btn-pills btn-soft-primary dropdown-toggle p-0 ${
                      (toggleID === patient.id && "show") || ""
                    }`}
              ...
              <div class="card-body p-0 pt-3">
                ...
                <ul class="mb-0 list-unstyled mt-2">
                  <li class="mt-1">
                    <span class="text-muted me-2">Gender:</span>Male
                  </li>
                  <li class="mt-1">
                    <span class="text-muted me-2">Age:</span>25years
                  </li>
                  <li class="mt-1">
                    <span class="text-muted me-2">Country:</span>USA
                  </li>
                  <li class="mt-1">
                    <span class="text-muted me-2">Diagnosis:</span>Heart Attack
                  </li>
                </ul>
              </div>
            </div>
