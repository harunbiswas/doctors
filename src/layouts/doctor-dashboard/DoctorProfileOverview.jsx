...
export default function DoctorProfileOverview(){
    ...
    return(
        <>
        <div className="tab-pane fade show active" id="pills-overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <h5 className="mb-1">Dr. Christopher Burrell</h5>
                                    <a href="#" className="text-primary">Gynecologist</a>, &nbsp;
                                    <a href="#" className="text-primary">Ph.D</a>
                                    ...
                                    <ul className="list-unstyled mt-4">
                                        <li className="mt-1"><i className="uil uil-arrow-right text-primary"></i> Women's health services</li>
                                        <li className="mt-1"><i className="uil uil-arrow-right text-primary"></i> Pregnancy care</li>
                                        <li className="mt-1"><i className="uil uil-arrow-right text-primary"></i> Surgical procedures</li>
                                        <li className="mt-1"><i className="uil uil-arrow-right text-primary"></i> Specialty care</li>
                                        <li className="mt-1"><i className="uil uil-arrow-right text-primary"></i> Conclusion</li>
                                    </ul>
