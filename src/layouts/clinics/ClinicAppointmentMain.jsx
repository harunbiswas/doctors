...
export default function ClinicAppointmentMain() {
  ...
  useEffect(() => {
    const url = `${Values.BASE_URL}/clinic/appointments`;
    axios
      .get(url, {
        headers: {
          clinicid: JSON.parse(localStorage.getItem("login")).value.loginData
            .id,
        },
      })
      .then((d) => {
